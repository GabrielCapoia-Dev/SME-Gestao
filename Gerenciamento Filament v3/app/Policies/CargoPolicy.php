...
class CargoPolicy
{
    ...
    {
        return $user->hasPermissionTo('Listar Cargos');
    }
    ...
    {
        return $user->hasPermissionTo('Criar Cargos');
    ...
    {
        return $user->hasPermissionTo('Editar Cargos');
    ...
    {
        return $user->hasPermissionTo('Excluir Cargos');
